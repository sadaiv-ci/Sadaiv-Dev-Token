...
export interface SadaivDeveloperTokenInterface extends utils.Interface {
  functions: {
...
export interface SadaivDeveloperToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SadaivDeveloperTokenInterface;
